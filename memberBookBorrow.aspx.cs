...
{
    public partial class MemberBookRequest : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            // Set the due date to today's date + 7 days
            TextBox6.Text = DateTime.Today.AddDays(7).ToString("yyyy-MM-dd");
            getNames();
        }
        ...
        void returnBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Delete from book_issue_tbl WHERE book_id='" + TextBox1.Text.Trim() + "' AND member_id='" + Session["username"] + "'", con);
        ...
        bool checkIfMemberExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select full_name from member_master_tbl WHERE member_id='" + Session["username"] + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        bool checkIfIssueEntryExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from book_issue_tbl WHERE member_id='" + Session["username"] + "' AND book_id='" + TextBox1.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        void getNames()
        {
            try
            {
                ...
                cmd = new SqlCommand("select full_name from member_master_tbl WHERE member_id='" + Session["username"] + "'", con);
