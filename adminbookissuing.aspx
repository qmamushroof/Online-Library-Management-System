<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="Online_Library_Management.adminbookissuing" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-6">
                        <asp:Button ID="Button4" class="btn btn-lg btn-block btn-success" runat="server" Text="Take Back" OnClick="Button4_Click" />
                     </div>
                  </div>
               </div>
            </div>
