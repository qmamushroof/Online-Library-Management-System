<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="Online_Library_Management.adminmembermanagement" %>
                  ...
                  <div class="row">
                     <div class="col-mid-6">
                      ...
                      <%--<div class="col-md-3">
                        <label>Fine</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBoxFine" runat="server" placeholder="Fine" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>--%>
                  </div>
