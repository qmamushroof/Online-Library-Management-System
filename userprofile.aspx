<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Online_Library_Management.userprofile" %>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     <div class="col-md-4">
                        <label>Fine</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBoxFine" runat="server" placeholder="Fine" ReadOnly="True"></asp:TextBox>                                                    
                        </div>
                     </div>
                       <div style="color:lightslategrey">
                       Pay fine(if any) via Bkash at 01531824939 with your id as reference
                       </div>
                    </div>
